...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		{
			case 'era':
				dialogue = CoolUtil.coolTextFile(Paths.txt('era/dialog'));
			case 'bpm':
				dialogue = CoolUtil.coolTextFile(Paths.txt('bpm/dialog'));
			case 'freaky':
				dialogue = CoolUtil.coolTextFile(Paths.txt('freaky/dialog'));
			case 'senpai':
		...
		switch(SONG.stage)
		{
			...
			case 'studio':
			{
						defaultCamZoom = 0.9;
						curStage = 'studio';
						var bg:FlxSprite = new FlxSprite(-600, -200).loadGraphic(Paths.image('studio/studiobg'));
						bg.antialiasing = true;
		...
		healthBar.createFilledBar(0xFFFCE43D, 0xFF31B0D1);
		// healthBar
		add(healthBar);
